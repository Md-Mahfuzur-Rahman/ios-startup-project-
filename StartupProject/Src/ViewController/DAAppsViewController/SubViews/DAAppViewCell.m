...
#define FONT_NAME_REGULAR @"Roboto-Regular"

#define APP_BASE_COLOR [UIColor colorWithRed: (216.0/255.0) green: (27.0/255.0) blue: (97.0/255.0) alpha: 1.0]
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        cellTopWhiteLine.backgroundColor = [UIColor colorWithWhite:1.0 alpha:0.1];
        ...
        _nameLabel.font = [UIFont fontWithName: FONT_NAME_REGULAR size: 12.0f];
        _nameLabel.backgroundColor = [UIColor clearColor];
        _nameLabel.textColor = [UIColor colorWithWhite:0.0 alpha:0.8];
        [self addSubview:_nameLabel];
        
        _genreLabel = [[UILabel alloc] init];
        _genreLabel.font = [UIFont fontWithName: FONT_NAME_REGULAR size: 10.0f];
        ...
        _noRatingsLabel.font = [UIFont fontWithName: FONT_NAME_REGULAR size: 10.0f];
        _noRatingsLabel.textColor = [UIColor redColor];
        ...
        _ratingsLabel.font = [UIFont fontWithName: FONT_NAME_REGULAR size: 10.0f];
        ...
        if (DA_IS_IOS7) {
            UIColor *titleColor = APP_BASE_COLOR;
