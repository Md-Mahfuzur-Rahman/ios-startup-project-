...
#import <MediaShareUI/MediaShareUI.h>
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [PurchaseViewPresenter restoreTransactions];
...
- (NSManagedObjectContext*) managedObjectContext{
    return [[KGCoreDataContext sharedInstance] defaultContext];
}

- (void) saveManagedObjectContext{
    [[KGCoreDataContext sharedInstance] saveContext:[self managedObjectContext]];
}
